...
public class TagCloudView extends ViewGroup{
    ...
    private static final int DEFAULT_TAG_RESID = R.layout.tagcloudview_item_tag;
    private static final int DEFAULT_RIGHT_IMAGE = R.drawable.accessory;
    ...
    private int getTextTotalWidth() {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            View child = getChildAt(i);
            if (child.getTag() != null && ((Integer)child.getTag()).intValue() == TYPE_TEXT_NORMAL) {
