 ...
 * @date 2016/7/15
 */
public class CommuServerLayout extends LinearLayout {
    private Context context;

    private TextView tv_title;
    private LinearLayout server_item_layout;

    public CommuServerLayout(Context context) {
        super(context);
        this.context = context;
        init();
    }

    public CommuServerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        init();
    }
    ...
    private void init() {
        LayoutInflater.from(context).inflate(R.layout.commu_server_layout, this);
        findViews();
    }
    ...
    public void notifyLayoutDataChange(String str, final List<AppListBean> appList) {
        ...
        if (appList != null && appList.size() > 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                lp.width = (int) ((Utils.mScreenWidth - Utils.dip2px(30)) / 4.5f);
                lp.height = lp.width;
                ...
                server_item_layout.addView(view, i, lp);
            }
        }
    }
